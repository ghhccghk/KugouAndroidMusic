...
typedef int32_t(*ZN7android7content22AttributionSourceState14readFromParcelEPKNS_6ParcelE_t)(
        void *thisptr, void *parcel);
...
typedef void *(*ZN7android10AudioTrackC1ERKNS_7content22AttributionSourceStateE_t)(void *thisptr,
                                                                                   void *attributionSourceState);
...
typedef int32_t(*ZN7android10AudioTrack3setE19audio_stream_type_tj14audio_format_tjm20audio_output_flags_tPFviPvS4_ES4_jRKNS_2spINS_7IMemoryEEEbiNS0_13transfer_typeEPK20audio_offload_info_tiiPK18audio_attributes_t_t)
        (void *thisptr, int32_t streamType, uint32_t sampleRate, uint32_t format,
         uint32_t channelMask, size_t frameCount /* = 0 */, uint32_t flags /* = 0 */,
         legacy_callback_t callback /* = nullptr */, void *user /* = nullptr */,
         int32_t notificationFrames /* = 0 */, fake_sp &sharedMemory /* = nullptr */,
         bool threadCanCallJava /* = false */, int32_t audioSessionId /* = 0 */,
         int32_t transferType /* = TRANSFER_DEFAULT */, void *offloadInfo /* = nullptr */, int uid,
         pid_t pid, void *attributes /* = nullptr */);
...
typedef int32_t(*ZN7android10AudioTrack3setE19audio_stream_type_tj14audio_format_t20audio_channel_mask_tm20audio_output_flags_tRKNS_2wpINS0_19IAudioTrackCallbackEEEiRKNS_2spINS_7IMemoryEEEb15audio_session_tNS0_13transfer_typeEPK20audio_offload_info_tRKNS_7content22AttributionSourceStateEPK18audio_attributes_tbfi_t)
        (void *thisptr, int32_t streamType, uint32_t sampleRate, uint32_t format,
         uint32_t channelMask, size_t frameCount /* = 0 */, uint32_t flags /* = 0 */,
         fake_wp &callback /* = nullptr */, int32_t notificationFrames /* = 0 */,
         fake_sp &sharedMemory /* = nullptr */, bool threadCanCallJava /* = false */,
         int32_t audioSessionId /* = 0 */, int32_t transferType /* = TRANSFER_DEFAULT */,
         void *offloadInfo /* = nullptr */, int &attributionSource,
         void *attributes /* = nullptr */, bool doNotReconnect /* = false */,
         float maxRequiredSpeed /* = 1.0f */, int selectedDeviceId /* = 0 */);
...
typedef int32_t(*ZN7android10AudioTrack3setE19audio_stream_type_tj14audio_format_tjm20audio_output_flags_tPFviPvS4_ES4_iRKNS_2spINS_7IMemoryEEEb15audio_session_tNS0_13transfer_typeEPK20audio_offload_info_tjiPK18audio_attributes_tbfi_t)
        (void *thisptr, int32_t streamType, uint32_t sampleRate, uint32_t format,
         ...
         int32_t notificationFrames /* = 0 */, fake_sp &sharedMemory /* = nullptr */,
         bool threadCanCallJava /* = false */, int32_t audioSessionId /* = 0 */,
         int32_t transferType /* = TRANSFER_DEFAULT */, void *offloadInfo /* = nullptr */,
         uid_t uid, pid_t pid, void *attributes /* = nullptr */, bool doNotReconnect /* = false */,
         float maxRequiredSpeed /* = 1.0f */, int selectedDeviceId /* = 0 */);
...
typedef int32_t(*ZN7android10AudioTrack3setE19audio_stream_type_tj14audio_format_tjm20audio_output_flags_tPFviPvS4_ES4_iRKNS_2spINS_7IMemoryEEEb15audio_session_tNS0_13transfer_typeEPK20audio_offload_info_tiiPK18audio_attributes_tbf_t)
        (void *thisptr, int32_t streamType, uint32_t sampleRate, uint32_t format,
         ...
         bool threadCanCallJava /* = false */, int32_t audioSessionId /* = 0 */,
         int32_t transferType /* = TRANSFER_DEFAULT */, void *offloadInfo /* = nullptr */, int uid,
         pid_t pid, void *attributes /* = nullptr */, bool doNotReconnect /* = false */,
         float maxRequiredSpeed /* = 1.0f */);
...
typedef int32_t(*ZN7android11AudioSystem16getOutputForAttrEPK18audio_attributes_tPi15audio_session_tP19audio_stream_type_tjj14audio_format_tj20audio_output_flags_tiPK20audio_offload_info_t_t)(
        void *attr, int32_t *output, int32_t session, int32_t *stream, uid_t uid,
        uint32_t samplingRate, int32_t format, int32_t channelMask, int32_t flags,
        int32_t selectedDeviceId, void *offloadInfo);
...
typedef int32_t(*ZN7android11AudioSystem15getSamplingRateEiPj_t)(int32_t output,
                                                                 uint32_t *sampleRate);

static ZN7android11AudioSystem15getSamplingRateEiPj_t ZN7android11AudioSystem15getSamplingRateEiPj = nullptr;

typedef void(*ZN7android11AudioSystem13releaseOutputEi19audio_stream_type_t15audio_session_t_t)(
        uint32_t output, int32_t stream, int32_t session);
...
typedef int32_t(*ZN7android10AudioTrack15setOutputDeviceEi_t)(void *thisptr,
...
typedef bool(*ZN7android11AudioSystem18isOffloadSupportedERK20audio_offload_info_t_t)(
        audio_offload_info_t_v26 &offloadInfo);
...
typedef int32_t(*ZN7android11AudioSystem17getOffloadSupportERK20audio_offload_info_t_t)(
        audio_offload_info_t_v30 &offloadInfo);
...
typedef int32_t(*ZN7android10AudioTrack22addAudioDeviceCallbackERKNS_2spINS_11AudioSystem19AudioDeviceCallbackEEE_t)(
        void *thisptr, fake_sp &cb);
...
typedef int32_t(*ZN7android10AudioTrack25removeAudioDeviceCallbackERKNS_2spINS_11AudioSystem19AudioDeviceCallbackEEE_t)(
        void *thisptr, fake_sp &cb);
...
typedef bool(*ZN7android10AudioTrack12pauseAndWaitERKNSt3__16chrono8durationIxNS1_5ratioILl1ELl1000EEEEE_t)(
        void *thisptr, const std::chrono::milliseconds &timeout);
...
typedef int32_t(*ZN7android10AudioTrack7setLoopEjji_t)(void *thisptr, uint32_t start, uint32_t end,
                                                       int32_t count);
...
typedef int32_t(*ZNK7android10AudioTrack23getPositionUpdatePeriodEPj_t)(void *thisptr,
                                                                        uint32_t *pos);
...
typedef int32_t(*ZN7android10AudioTrack15setPlaybackRateERKNS_17AudioPlaybackRateE_t)(void *thisptr,
...
typedef int32_t(*ZN7android10AudioTrack15pendingDurationEPiNS_17ExtendedTimestamp8LocationE_t)(
        void *thisptr, int32_t *out, int location);
...
typedef int32_t(*ZN7android10AudioTrack12getTimestampEPNS_17ExtendedTimestampE_t)(void *thisptr,
...
typedef int32_t(*ZN7android10AudioTrack16getMinFrameCountEPm19audio_stream_type_tj_t)(
        int32_t streamType, int32_t sampleRateHz);
...
typedef int32_t(*ZN7android10AudioTrack13setParametersERKNS_7String8E_t)(void *thisptr,
                                                                         String8 &s8);
...
typedef String8(*ZN7android10AudioTrack13getParametersERKNS_7String8E_t)(void *thisptr,
                                                                         String8 &s8);
...
typedef int32_t(*ZN7android10AudioTrack12getTimestampERNS_14AudioTimestampE_t)(void *thisptr,
...
typedef ssize_t(*ZN7android10AudioTrack5writeEPKvjb_t)(void *thisptr, void *buf, uint32_t len,
                                                       bool blocking);

static ZN7android10AudioTrack5writeEPKvjb_t ZN7android10AudioTrack5writeEPKvjb = nullptr;

typedef int32_t(*ZN7android10AudioTrack12obtainBufferEPNS0_6BufferEiPj_t)(void *thisptr,
...
typedef void(*ZN7android10AudioTrack13releaseBufferEPKNS0_6BufferE_t)(void *thisptr,
                                                                      android::AudioTrack::Buffer *buf);
...
#undef TRY_GET_JNI
    ...
    void onNewTimestamp(android::AudioTimestamp timestamp) override {
        ...
        mEnv->CallVoidMethod(mCallback, mOnNewTimestamp,
                             ...
                             (jlong) ((timestamp.mTime.tv_sec * 1000000000LL) +
    ...
    size_t onCanWriteMoreData(const android::AudioTrack::Buffer &buffer) override {
        if (!mCallback || mHolder->died || !mOnCanWriteMoreData ||
            !maybeAttachThread(__func__))
            return 0;
...
static void
callOnAudioDeviceUpdate(track_holder *holder, int audioIo, const DeviceIdVector &deviceIds) {
...
Java_org_nift4_gramophone_hificore_NativeTrack_00024Companion_initDlsym(JNIEnv *env, jobject) {
    ...
    if (android_get_device_api_level() >= 31) {
        DLSYM_OR_RETURN(libandroid_runtime, ZN7android19parcelForJavaObjectEP7_JNIEnvP8_jobject,
                        false)
        DLSYM_OR_RETURN(libpermission,
                        ZN7android7content22AttributionSourceState14readFromParcelEPKNS_6ParcelE,
                        false)
        DLSYM_OR_RETURN(libaudioclient,
                        ZN7android10AudioTrackC1ERKNS_7content22AttributionSourceStateE, false)
    } else {
    ...
    if (android_get_device_api_level() >= 31) {
        DLSYM_OR_RETURN(libaudioclient,
                        ZN7android11AudioSystem17getOffloadSupportERK20audio_offload_info_t, false)
    } else {
        DLSYM_OR_RETURN(libaudioclient,
                        ZN7android11AudioSystem18isOffloadSupportedERK20audio_offload_info_t, false)
    }
    ...
    if (android_get_device_api_level() >= 23) {
        ...
        DLSYM_OR_RETURN(libaudioclient,
                        ZN7android10AudioTrack22addAudioDeviceCallbackERKNS_2spINS_11AudioSystem19AudioDeviceCallbackEEE,
                        false)
        DLSYM_OR_RETURN(libaudioclient,
                        ZN7android10AudioTrack25removeAudioDeviceCallbackERKNS_2spINS_11AudioSystem19AudioDeviceCallbackEEE,
                        false)
        ...
        DLSYM_OR_RETURN(libaudioclient,
                        ZN7android10AudioTrack15setPlaybackRateERKNS_17AudioPlaybackRateE, false)
    } else {
    ...
    if (android_get_device_api_level() >= 24) {
        ...
        DLSYM_OR_RETURN(libaudioclient,
                        ZN7android10AudioTrack15pendingDurationEPiNS_17ExtendedTimestamp8LocationE,
                        false)
        DLSYM_OR_RETURN(libaudioclient,
                        ZN7android10AudioTrack12getTimestampEPNS_17ExtendedTimestampE, false)
    }
    DLSYM_OR_RETURN(libaudioclient,
                    ZN7android10AudioTrack16getMinFrameCountEPm19audio_stream_type_tj, false)
    if (android_get_device_api_level() == 23) {
    ...
    if (android_get_device_api_level() >= 32) {
        DLSYM_OR_RETURN(libaudioclient,
                        ZN7android10AudioTrack12pauseAndWaitERKNSt3__16chrono8durationIxNS1_5ratioILl1ELl1000EEEEE,
                        false)
    }
    ...
    DLSYM_OR_RETURN(libaudioclient, ZN7android10AudioTrack12getTimestampERNS_14AudioTimestampE,
                    false)
...
Java_org_nift4_gramophone_hificore_NativeTrack_create(
    ...
    if (holder->deviceCallback) {
        ...
        int32_t ret = ZN7android10AudioTrack22addAudioDeviceCallbackERKNS_2spINS_11AudioSystem19AudioDeviceCallbackEEE(
                theTrack, cb);
        if (ret != 0) {
        ...
        *(int32_t*)((uintptr_t)holder->track + 0x254) = selectedDeviceId;
        ...
        if (maxRequiredSpeed > 1.0f) {
            ...
            minFrameCount = (int32_t) ((double) (minBufCount < 2 ? 2 : minBufCount) *
                                       (double) (sampleRate == afSampleRate ? afFrameCount
                                                                            : (size_t) (
                                                       (uint64_t) afFrameCount *
            ...
            release:
            ZN7android11AudioSystem13releaseOutputEi19audio_stream_type_t15audio_session_t(output,
                                                                                           streamType,
                                                                                           sessionId);
        }
        fallback:
        ...
        case 22:
            extra =
                    ...
                    (dlsym(libaudioclient_handle,
                           "_ZN7android10AudioTrack28initializeTrackOffloadParamsEv")
                     #ifdef __LP64__
                     ? 0x20 /* 0x20c */ : 0x0);
...
Java_org_nift4_gramophone_hificore_NativeTrack_getProxy(JNIEnv *env, jobject, jlong ptr,
                                                        jint sessionId) {
    if (android_get_device_api_level() < 24) {
...
Java_org_nift4_gramophone_hificore_NativeTrack_dtor(
    ...
    if (holder->deviceCallback) {
        fake_sp cb = {.thePtr=holder->deviceCallback};
        int ret = ZN7android10AudioTrack25removeAudioDeviceCallbackERKNS_2spINS_11AudioSystem19AudioDeviceCallbackEEE(
                holder->track, cb);
        if (ret != 0) {
...
Java_org_nift4_gramophone_hificore_NativeTrack_00024Companion_isOffloadSupported(
    ...
    if (android_get_device_api_level() >= 31) {
        return ZN7android11AudioSystem17getOffloadSupportERK20audio_offload_info_t(
                offloadInfo.newInfo);
    } else {
        return ZN7android11AudioSystem18isOffloadSupportedERK20audio_offload_info_t(
                offloadInfo.oldInfo);
    }
}
...
extern "C"
JNIEXPORT jlong JNICALL
Java_org_nift4_gramophone_hificore_NativeTrack_writeInternal__JLjava_nio_ByteBuffer_2IIZ(
        JNIEnv *env,
        jobject,
        jlong ptr,
        jobject buf,
...
Java_org_nift4_gramophone_hificore_NativeTrack_writeInternal__J_3FIIZ(JNIEnv *env, jobject,
    ...
    void *base = buffer + offset;
    ssize_t ret = ZN7android10AudioTrack5writeEPKvjb(holder->track, base, size * sizeof(jfloat),
                                                     blocking);
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_org_nift4_gramophone_hificore_NativeTrack_pauseAndWaitInternal(JNIEnv *, jobject, jlong ptr,
                                                                    jlong timeout) {
    auto holder = (track_holder *) ptr;
    if (holder->died)
        return true;
    std::chrono::milliseconds millis(timeout);
    return ZN7android10AudioTrack12pauseAndWaitERKNSt3__16chrono8durationIxNS1_5ratioILl1ELl1000EEEEE(
            holder->track, millis);
}
...
Java_org_nift4_gramophone_hificore_NativeTrack_getRoutedDevicesInternal(JNIEnv *env, jobject,
    ...
    if (android_get_device_api_level() >= 34) {
        std::vector<int32_t> deviceIds = ZN7android10AudioTrack18getRoutedDeviceIdsEv(
                holder->track);
        jintArray deviceIdsJni;
        deviceIdsJni = env->NewIntArray((int32_t) deviceIds.size());
        if (deviceIdsJni == nullptr) {
...
Java_org_nift4_gramophone_hificore_NativeTrack_getBufferDurationInUsInternal(JNIEnv *,
    ...
    if (ret != 0) {
        if (ret > 0) {
            ALOGE("getBufferDurationInUs returned positive error code %d, this should never happen",
                  ret);
            return -1;
        }
        return ret;
...
Java_org_nift4_gramophone_hificore_NativeTrack_pendingDurationInternal(JNIEnv *, jobject,
    ...
    int32_t out;
    auto holder = (track_holder *) ptr;
    int ret = ZN7android10AudioTrack15pendingDurationEPiNS_17ExtendedTimestamp8LocationE(
            holder->track, &out, location);
...
Java_org_nift4_gramophone_hificore_NativeTrack_getTimestamp2Internal(JNIEnv *env, jobject,
    ...
    env->SetLongArrayRegion(mPosition, 0, sizeof(ts.mPosition) / sizeof(jlong),
                            (jlong *) &ts.mPosition);
    env->SetLongArrayRegion(mTimeNs, 0, sizeof(ts.mTimeNs) / sizeof(jlong), (jlong *) &ts.mTimeNs);
    env->SetLongArrayRegion(mTimebaseOffset, 0, sizeof(ts.mTimebaseOffset) / sizeof(jlong),
                            (jlong *) &ts.mTimebaseOffset);
...
Java_org_nift4_gramophone_hificore_NativeTrack_00024Companion_getMinFrameCountInternal(JNIEnv *,
    ...
    return ZN7android10AudioTrack16getMinFrameCountEPm19audio_stream_type_tj(stream_type,
                                                                             sample_rate_in_hz);
}